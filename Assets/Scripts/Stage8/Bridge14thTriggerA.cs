...
public class Bridge14thTriggerA : MonoBehaviour {
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            working = 1;
            Bridge14thController.state = 0;
            Bridge14thController.RotateController = true;
            Bridge14thEndController.state = 0;
            Bridge14thEndController.RotateController = true;
        }
    }
}
