...
public class Bridge10thEndController : MonoBehaviour {
    ...
    void Update()
    {
        if (RotateController)
        {
            targetRotation = Quaternion.Euler(0, 0, RotateAngle * state + Bridge10thController.RotateAngle * Bridge10thController.state) * Quaternion.identity;
