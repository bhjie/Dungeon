...
public class Bridge2ndEndController : MonoBehaviour {
    ...
    void Update ()
    {
        if (RotateController)
        {
            targetRotation = Quaternion.Euler(0, 0, RotateAngle * state + Bridge2ndController.RotateAngle * Bridge2ndController.state) * Quaternion.identity;
